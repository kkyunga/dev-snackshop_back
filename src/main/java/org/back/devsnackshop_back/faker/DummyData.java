...
//    private final MiddlewareRepository middlewareEntityRepository;
//
//    @Override
//    public void run(String... args) {
//        if (userRepository.count()<=0) userData();
//        if (privilegeRepository.count()<=0) privilegeData();
//        if (cloudRepository.count()<=0) cloudData();
//        if (operatingSystemRepository.count()<=0) operateSettingData();
...
//        });
//
//        cloudRepository.saveAll(result);
//    }
//
//
...
//            result.add(entity);
//        }
//        operatingSystemRepository.saveAll(result);
//    }
//
